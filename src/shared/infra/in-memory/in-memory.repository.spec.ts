...
describe('InMemoryRepository unit test', () => {
    ...
    it('should returns all entities', async () => {
        const aggregate = new StubEntity({name: 'name', price: 1});
    ...
    it('should throws error on delete when entity not found', async () => {
        ...
        await expect(
            repo.delete(new Uuid('8a6e0804-2bd0-4672-b79d-d97027f9071a'))
        ).rejects.toThrow(
            new NotFoundError('8a6e0804-2bd0-4672-b79d-d97027f9071a', StubEntity)
        );
    });
